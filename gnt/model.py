...
from gnt.activation_checkpoint import checkpoint_wrapper
...
class GNTModel(object):
    def __init__(self, args, load_opt=True, load_scheduler=True):
        ...
        if args.distributed:
            ...
            # Applying activation checkpointing to save memory
            self.feature_net = checkpoint_wrapper(self.feature_net)
